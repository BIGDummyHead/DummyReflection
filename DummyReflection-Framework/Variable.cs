...
namespace DummyReflection
{
    ...
    public class Variable
    {
        ...
        /// </summary>
        public MemberInfo MInfo { get; private set; }
        ...
        public Variable(MemberInfo member, object instance = null, bool requireInstance = false)
        {
            ...
            if (!(MInfo is PropertyInfo) && !(MInfo is FieldInfo))
                throw invalidInfo;
        ...
        private readonly Exception invalidInfo =
            new Exception("Invalid MemberInfo provided, please provide only FieldInfo or PropertyInfo");
