...
namespace DummyReflection
{
    ...
    public static class Reflector
    {
        ...
        /// <param name="bindingFlags">Flags of the field or property, set to all for easy purposes</param>
        /// <returns>A variable that may be read or written to. May be null</returns>
        public static Variable? GetStaticVariable(this Type type, string name, BindingFlags bindingFlags = (BindingFlags)(-1))
        {
        ...
        /// <returns></returns>
        public static object? CreateInstance(this ConstructorInfo info, params object[] args)
        {
        ...
        /// <param name="info">CTOR</param>
        /// <param name="args">Args to pass in</param>
        /// <returns>Object? casted to a T?</returns>
        public static T? CreateInstance<T>(this ConstructorInfo info, params object[] args)
        {
            return (T?)info.CreateInstance(args);
        }
        ...
        /// <summary>
        /// A recursive method to determine if <paramref name="a"/> inherit <paramref name="b"/>, see return
        /// </summary>
        /// <param name="a"></param>
        /// <param name="b"></param>
        /// <returns>True if a : b or b : a</returns>
